    ...
    <article className="container py-5">
      ...
      <section className="pb-4">
        ...
        <p>
          ...
          Hessionite) Pyrope and Uvarovite. There are many more varieties which
          are combinations of two or more of the six major varieties.
        </p>
        <ol>
          <li>
            Pyrope is usually vivid red to deep red. Rhodolite, a combination of
            Pyrope and Almandine, is light to dark purplish pink.
          </li>
          <li>Almandine is dark red to brownish red.</li>
          <li>
            Andradite is yellow to brown. The green variety is called Demantoid.
          </li>
          <li>
            Grossular is yellow orange to brown. The green variety is Tsavorite.
          </li>
        ...
        <p>
          Garnets have a scratch hardness of 6.5 to 7.5 and require no treatment
          to enhance them other than polishing.
        </p>
        <p>
        ...
        <p>
          ...
          appearance to the unaided eye. Then examine under 10x magnification to
          look for any durability issues.
        </p>
        <p>
