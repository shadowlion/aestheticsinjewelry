    ...
    <article className="container py-5">
      ...
      <section className="pb-4">
        ...
        <p>
          ...
          birthstone for June. It is a traditional gift for brides, graduations,
        ...
        <p>
          ...
          required to form a Freshwater Pearl. It is this lack of a starting
          bead that causes the formation of a Freshwater Cultured Pearl to be
          almost identical to the early Natural Pearl that are almost wholly
          nacre and so rare and so valuable.
        </p>
        <p>
        ...
        <p>
          ...
          gemstones. It was discovered in 1834, in Russia, named in honor of and
          presented to Alexander II at his coming of age ceremony.
        </p>
        <p>
        ...
        <p>
          ...
          Alexandrite one of the more everyday wearable stones for connoisseurs
          and collectors.
        </p>
      </section>
    </article>
