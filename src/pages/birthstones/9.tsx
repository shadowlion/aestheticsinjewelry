...
const BirthstonePage = () => {
  return (
    <>
      <Head>
        <title>Sapphire | Aesthetics in Jewelry</title>
        <meta
          name="description"
          content="Aesthetics in Jewelry - Sapphire Page"
        />
      ...
      <article className="container py-5">
        ...
        <section className="pb-4">
          ...
          <p>
            ...
            stunning violet-blue gemstone because the word “Sapphire” is Greek
            for blue. For centuries, the Sapphire has been referred to as the
            ultimate blue gemstone. Since Ancient times the Blue Sapphire
            represented a promise of honesty, loyalty, purity and trust. To keep
            with this tradition Sapphires are one of the most popular engagement
            gemstones today.
          </p>
          <p>
